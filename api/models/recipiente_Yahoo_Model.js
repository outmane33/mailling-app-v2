...
const recipienteYahooSchema = new Schema(
  {
    email: {
      type: String,
...
const Recipiente_Yahoo =
  mongoose.models.Recipiente_Yahoo ||
  mongoose.model("Recipiente_Yahoo", recipienteYahooSchema);

module.exports = Recipiente_Yahoo;
